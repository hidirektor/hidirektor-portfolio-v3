  ...
  return (
    <div className="preferences-widget-btn fixed bottom-12 right-0 z-[9999] h-14 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 shadow-2xl transition-all duration-500 ease-in-out flex items-center overflow-hidden cursor-pointer w-14 rounded-l-[1rem]">
      ...
      <div className="pref-content flex-1 flex items-center gap-4 px-2 whitespace-nowrap transition-opacity duration-300 opacity-0">
        ...
        <button onClick={toggleTheme} className="flex items-center justify-center w-8 h-8 hover:opacity-70 transition-opacity" aria-label="Toggle theme">
          {isDark ? (
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-sun" aria-hidden="true">
