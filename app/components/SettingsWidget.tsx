...
export default function SettingsWidget() {
  ...
  return (
    <div className="preferences-widget-btn fixed top-1/3 right-0 z-[9999] h-14 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 shadow-2xl transition-all duration-500 ease-in-out flex items-center overflow-hidden cursor-pointer w-14 rounded-l-[1rem] -translate-y-1/2">
